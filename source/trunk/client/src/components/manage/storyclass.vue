...
<script>
	...
	export default {
		...
		methods: {
			...
			saveEdit(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/story/updatestoryclass.do',
			...
			deleteEdit(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/story/deletestoryclass.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
					data: JSON.stringify({
						'token':tszs.getCookie("token"),
			...
			savaEditOrder(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/story/updatestoryclassorder.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
					data: JSON.stringify({
						'token':tszs.getCookie("token"),
			...
			addEdit() {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/story/addstoryclass.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
	...
	function loadData(_self)
	{
		$.ajax({
			type: 'POST',
			url: tszs.GetApiRootPath()+'/manage/story/storyclass.do',
			contentType: "application/json; charset=utf-8",
			dataType: "json",
			data: JSON.stringify({'token':tszs.getCookie("token")}),
			timeout: 5000,
