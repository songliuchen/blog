	...
	export default {
		...
		methods: {
			...
			saveEdit(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/technology/updatetechnologyclass.do',
			...
			deleteEdit(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/technology/deletetechnologyclass.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
					data: JSON.stringify({
						'token':tszs.getCookie("token"),
			...
			savaEditOrder(index) {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/technology/updatetechnologyclassorder.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
					data: JSON.stringify({
						'token':tszs.getCookie("token"),
			...
			addEdit() {
				...
				$.ajax({
					type: 'POST',
					url: tszs.GetApiRootPath()+'/manage/technology/addtechnologyclass.do',
					contentType: "application/json; charset=utf-8",
					dataType: "json",
