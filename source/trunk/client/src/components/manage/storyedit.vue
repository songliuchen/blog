...
<script>
	...
	export default {
		...
		methods: {
			...
			saveEdit() {
				...
				if(tszs.IsNullOrEmpty(id)) {
					$.ajax({
						type: 'POST',
						url: tszs.GetApiRootPath()+'/manage/story/addstory.do',
					...
					$.ajax({
						type: 'POST',
						url: tszs.GetApiRootPath()+'/manage/story/updatestorydetail.do',
						contentType: "application/json; charset=utf-8",
						dataType: "json",
						data: JSON.stringify(dataparams),
						timeout: 5000,
		...
		beforeCreate: function() {
			...
			$.ajax({
				type: 'POST',
				url: tszs.GetApiRootPath()+'/manage/story/querystorydetail.do',
				contentType: "application/json; charset=utf-8",
				dataType: "json",
