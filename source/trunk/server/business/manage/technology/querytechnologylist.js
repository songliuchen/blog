...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article.id as id ,bt_folder.captione as class,caption,labels,grabble,date_format(bt_article.publish, '%y-%m-%d') as publish,numcomm,numview,bt_member.username as author from bt_article ,bt_folder,bt_member  where bt_folder.id = bt_article.parent and bt_article.author = bt_member.id ";
