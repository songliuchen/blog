...
exports.Execute=function(req,res)
{
    ...
    var sql = "delete bt_folder,bt_article,bt_comment from bt_folder left join bt_article on bt_article.parent=bt_folder.id left join bt_comment on bt_comment.parent = bt_article.id where bt_folder.id="+id;
    console.log("删除分类数据");
    console.log(sql);
