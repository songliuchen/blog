...
exports.Execute=function(req,res)
{
    ...
    var sql = "update bt_folder_demo as f1 join bt_folder_demo as f2 on f1.Sortinge="+id1+" and f2.Sortinge = "+id2+" set f1.Sortinge = f2.Sortinge,f2.Sortinge=f1.Sortinge";
