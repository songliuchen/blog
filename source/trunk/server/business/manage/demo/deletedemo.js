...
exports.Execute=function(req,res)
{
    ...
    var sql = "delete bt_article_demo,bt_comment from bt_article_demo left join bt_comment on bt_comment.parent = bt_article_demo.id where bt_article_demo.id="+id;
    console.log("删除文章数据");
    console.log(sql);
