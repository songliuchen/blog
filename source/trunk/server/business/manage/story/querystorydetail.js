...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article_story.*,bt_folder_story.captione as selectclass from bt_article_story,bt_folder_story where bt_article_story.parent = bt_folder_story.id  and bt_article_story.id="+id;
