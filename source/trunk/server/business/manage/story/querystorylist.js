...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article_story.id as id ,bt_folder_story.captione as class,caption,labels,grabble,date_format(bt_article_story.publish, '%y-%m-%d') as publish,numcomm,numview,bt_member.username as author from bt_article_story ,bt_folder_story,bt_member  where bt_folder_story.id = bt_article_story.parent and bt_article_story.author = bt_member.id ";
