...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article_story.id as id ,bt_folder_story.captione as class,caption,labels,logourl,grabble,DATE_FORMAT(publish, '%Y-%m-%d') as publish,numcomm,numview from bt_article_story ,bt_folder_story  where bt_folder_story.id = bt_article_story.parent ";
    ...
    {
        sql+=" and ";
        sql+= " bt_folder_story.id = "+captione+" ";
    }
