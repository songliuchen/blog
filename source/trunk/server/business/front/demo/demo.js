...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article_demo.id as id ,bt_folder_demo.captione as class,caption,labels,logourl,grabble,DATE_FORMAT(publish, '%Y-%m-%d') as publish,numcomm,numview from bt_article_demo ,bt_folder_demo  where bt_folder_demo.id = bt_article_demo.parent ";
    ...
    {
        sql+=" and ";
        sql+= " bt_folder_demo.id = "+captione+" ";
    }
