...
exports.Execute=function(req,res)
{
    ...
    var sql = "select bt_article.id as id,bt_folder.captione as class,caption,labels,content,DATE_FORMAT(publish, '%Y-%m-%d') as publish,numcomm,numview from bt_article ,bt_folder  where bt_folder.id = bt_article.parent ";
    sql+=" and ";
    sql+= " bt_article.id = "+id+" ";
    ...
    //更新阅读量
    sql = "update bt_article set  numview = numview+1 where id="+id;
